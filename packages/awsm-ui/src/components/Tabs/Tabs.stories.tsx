...
export const Base: Story = {
  ...
  args: {
    children: [
      ...
      <TabPanel key='1' id="tab-1">Awesome Content</TabPanel>,
      <TabPanel key='2' id="tab-2">This is Tab 2 Content</TabPanel>,
      <TabPanel key='3' id="tab-3">And Three Content</TabPanel>,
    ],
  },
};
